...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ✨ ĐÃ SỬA LẠI TRỌNG TÂM: Nhuộm thẳng màu xanh trùng với đáy của Gradient
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle(
        systemNavigationBarColor: Colors.blue.shade600, // Cùng màu xanh đáy màn hình
        systemNavigationBarIconBrightness: Brightness.light, // Giữ Icon màu trắng
      ),
      child: Scaffold(
        backgroundColor: Colors.blue.shade600, // Dự phòng thêm màu nền cho Scaffold
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              // Màu dưới cùng là shade600, sẽ khớp hoàn hảo với thanh systemNavigationBarColor
              colors: [Colors.blue.shade500, Colors.blue.shade400, Colors.blue.shade600],
            ),
          ),
          child: SafeArea(
