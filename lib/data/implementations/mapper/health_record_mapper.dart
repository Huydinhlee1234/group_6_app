...
class HealthRecordMapper {
  static HealthRecord toEntity(HealthRecordDto dto) {
    return HealthRecord(
  ...
  static UpdateInsertHealthRecordRequestDto toInsertRequest(HealthRecord entity) {
    return UpdateInsertHealthRecordRequestDto(
      ...
      completedStations: entity.completedStations,
    );
  }
}